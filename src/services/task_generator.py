    ...
    def generate_plan(
        ...
        if analysis.requires_frontend and analysis.frontend_task:
            ...
            fe_task = GeneratedTask(
                ...
                scope=ensure_bullet_points(fe_raw.scope, fallback="Implement frontend user interface and client integration."),
                expected_behavior=ensure_bullet_points(fe_raw.expected_behavior, fallback="User can interact with the interface with proper validation."),
                dependencies=ensure_bullet_points(fe_raw.dependencies, fallback="None identified"),
            ...
            if analysis.frontend_responsibilities:
                fe_task = GeneratedTask(
                    ...
                    scope=ensure_bullet_points(analysis.frontend_responsibilities, fallback="Implement frontend user interface and integration."),
                    expected_behavior="- User can interact with the interface with proper validation.\n- Loading and error states are handled gracefully.",
        ...
        if analysis.requires_backend and analysis.backend_tasks:
            for idx, be_raw in enumerate(analysis.backend_tasks, start=1):
                ...
                be_task = GeneratedTask(
                    ...
                    scope=ensure_bullet_points(be_raw.scope, fallback="Implement backend services and business logic."),
                    expected_behavior=ensure_bullet_points(be_raw.expected_behavior, fallback="Backend endpoints process requests according to business rules."),
                    dependencies=ensure_bullet_points(be_raw.dependencies, fallback="None identified"),
                    testing_considerations="",
                    acceptance_criteria=[],
                    assignee=dev_owner,
                    qa_owner=qa_owner,
            ...
            if analysis.backend_responsibilities:
                be_task = GeneratedTask(
                    ...
                    scope=ensure_bullet_points(analysis.backend_responsibilities, fallback="Implement backend services and business logic."),
                    expected_behavior="- Backend endpoints process requests according to business rules.\n- Database transactions and validation execute correctly.",
                    dependencies="- None identified",
                    testing_considerations="",
                    acceptance_criteria=[],
                    assignee=dev_owner,
